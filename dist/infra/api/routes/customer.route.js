...
const customer_repository_1 = __importDefault(require("../../customer/repositories/customer.repository"));
...
exports.customerRoute.get("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const usecase = new findAll_customer_usecase_1.default(new customer_repository_1.default());
    try {
